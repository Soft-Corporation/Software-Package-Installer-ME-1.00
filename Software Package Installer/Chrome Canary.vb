...
Public Class Chrome_Canary
    ...
    Private Sub Chrome_Canary_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_a176c0e12b3d48908e3d4dbf2931fb9d.zip"), Texbbb.TextBox53.Text)
        Timer1.Start()
